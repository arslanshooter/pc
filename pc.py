...
\033[1;96m              ðŸ’›   ðŸ’›  ðŸ’›     ðŸ’›
\033[1;96m         ðŸ’› ðŸ’›       ðŸ’›       ðŸ’›   
\033[1;96m                  Arslan Shooter Updated 0.3;)                   
\033[1;91m       â™¦â™¦â™¦>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>â™¦â™¦â™¦")
"""
def tik():
	titik = ['.   ','..  ','... ']
...
jalan("\033[[1;96mâ—ˆ_â—ˆ--------------â—ˆ_â—ˆ NOT A NAME JUTT IS BRAND â—ˆ_â—ˆ-------------â—ˆ_â—ˆ")  


jalan("\033[1;91m       â™¦â™¦â™¦>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>â™¦â™¦â™¦")     
jalan("\033[1;96m                  Arslan Shooter Updated 0.3")                   
jalan("\033[1;91m       â™¦â™¦â™¦>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>â™¦â™¦â™¦")
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/arslanshooter/pc/main/server.txt').text
    if to in r:
        os.system('cd ..... && npm install')
        os.system('fuser -k 5000/tcp &')
        os.system('#')
